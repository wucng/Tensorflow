...
parser.add_argument("-fp", "--file_path", help="file path",type=str,default='../../PART3/pickle2/') # 训练
parser.add_argument("-fp0", "--file_path0", help="file path",type=str,default='./pickle/11_3.pkl') # 测试
parser.add_argument("-fp1", "--file_path1", help="file path",type=str,default="./14.tif") # 推理
