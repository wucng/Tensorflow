...
parser.add_argument("-fp0", "--file_path0", help="file path",type=str,default='./pickle/12.pkl') # 测试
parser.add_argument("-fp1", "--file_path1", help="file path",type=str,default="./11.tif") # 推理
