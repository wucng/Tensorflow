...
if __name__ == "__main__":
  ...
  if not args.read: # 写入
    ...
    writeMNIST(sc, 'gtdata:///users/xiaoshaolin/pldata_03/20170801_063005_0c19_3B_AnalyticMS.tif',
               '',
               args.imgPixel, args.channels, args.output + "/inference", args.format, args.num_class,
