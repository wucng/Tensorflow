...
def main(_):
    ...
    if FLAGS.job_name == "ps":
        ...
        with tf.device(tf.train.replica_device_setter(
            ...
            m = Three_model.Model(Three_model.train).model()
        ...
        sv = tf.train.Supervisor(is_chief=(FLAGS.task_index == 0),
                                 ...
                                 global_step=Three_model.global_step,
                                 stop_grace_secs=300,
                                 save_model_secs=10,
        ...
        if Three_model.train == 1:  # train
            while not sv.should_stop():
                Three_model.Train_and_inference_model(sess,m).Train()
                break
