...
tf.app.flags.DEFINE_integer("epochs", 2, "Training the number of epochs")
tf.app.flags.DEFINE_integer("batch_size", 1, "Each training sample size")
...
# 超参数
isize = FLAGS.image_size
img_channel = FLAGS.image_channel
img_pixel = FLAGS.image_size

img_pixel_h = FLAGS.image_size
img_pixel_w = FLAGS.image_size
