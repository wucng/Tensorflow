    ...
    if FLAGS.job_name == "ps":
        ...
        with tf.device(tf.train.replica_device_setter(
            ...
            def conv_net(x, weights, biases, dropout):
                ...
                fc1 = tf.reshape(conv3, [-1, weights['wd1'].get_shape().as_list()[0]])  # [None,2*2*256]-->[None,1024]
            ...
            weights = {
                ...
                'wd1': tf.Variable(tf.random_normal([(img_pixel // 4) * (img_pixel // 4) * 256, 1024])),
        ...
        while not sv.should_stop() and epochs < training_epochs:
            ...
            for epoch in range(training_epochs):
                ...
                for i in range(total_batch):
                    ...
                    _, c, p, gl_step = sess.run([train_op, cost, pred, global_step], feed_dict={x: batch_xs,
                                                                                                 y: batch_ys,
                                                                                                 keep_prob: dropout})
