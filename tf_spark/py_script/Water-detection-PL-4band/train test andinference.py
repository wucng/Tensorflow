...
"""
参考：https://github.com/fengzhongyouxia/Tensorflow/blob/master/tf_spark/TensorflowOnSpark2/model/2x2/%E6%9C%80%E7%BB%88%E7%89%88/single_test.py
...
parser.add_argument("-fp0", "--file_path0", help="file path",type=str,default='./11_8.pkl') # 测试
