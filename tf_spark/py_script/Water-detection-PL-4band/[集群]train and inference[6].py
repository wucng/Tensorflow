...
机器1 ps:0 worker:1；机器2 ps:1 worker:0
机器1：
python mnist_dist.py --ps_hosts=10.0.100.15:2220,10.0.100.16:2221 --worker_hosts=10.0.100.15:2222,10.0.100.16:2223 --job_name="ps" --task_index=0
机器2:
python mnist_dist.py --ps_hosts=10.0.100.15:2220,10.0.100.16:2221 --worker_hosts=10.0.100.15:2222,10.0.100.16:2223 --job_name="ps" --task_index=1
机器2：
python mnist_dist.py --ps_hosts=10.0.100.15:2220,10.0.100.16:2221 --worker_hosts=10.0.100.15:2222,10.0.100.16:2223 --job_name="worker" --task_index=0
机器1:
python mnist_dist.py --ps_hosts=10.0.100.15:2220,10.0.100.16:2221 --worker_hosts=10.0.100.15:2222,10.0.100.16:2223 --job_name="worker" --task_index=1


#-----------------------------------------------------------------------------
机器1 ps:0 worker:0；机器2 ps:1 worker:1
机器1：
python mnist_dist.py --ps_hosts=10.0.100.15:2220,10.0.100.16:2221 --worker_hosts=10.0.100.15:2222,10.0.100.16:2223 --job_name="ps" --task_index=0
机器2:
python mnist_dist.py --ps_hosts=10.0.100.15:2220,10.0.100.16:2221 --worker_hosts=10.0.100.15:2222,10.0.100.16:2223 --job_name="ps" --task_index=1
