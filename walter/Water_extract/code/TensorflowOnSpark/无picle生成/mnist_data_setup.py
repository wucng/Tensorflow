...
if __name__ == "__main__":
  ...
  if not args.read: # 写入
    ...
    writeMNIST(sc, 'mnist/train_data.txt.gz', args.imgPixel, args.channels, args.output + "/train", args.format,
               args.num_partitions)  # 转换train数据
    writeMNIST(sc, 'mnist/test_data.txt.gz', args.imgPixel, args.channels, args.output + "/test", args.format,
