...
label_cols = img_pixel*img_pixel
dropout = 0.75 # Dropout, probability to keep units
img_nums=28874

total_batch = srcYSize//img_pixel*srcXSize//img_pixel*2
...
def conv_net(x, weights, biases, dropout):
    ...
    fc1 = tf.reshape(conv3, [-1, weights['wd1'].get_shape().as_list()[0]]) # [None,15*15*64]
...
# Evaluate model
accuracy=tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels=y, logits=pred))
