...
dir_name=r'F:\PL\20170321_022817_0e0d_visual\shp2\12345.tif' # 影像路径
...
dBuf=np.ones((isize,isize),np.uint8)*255  # 作为输出掩膜的像素
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, r"F:\PL\20170321_022817_0e0d_visual\train_data\model\save_net.ckpt")
        flagY = True
        for i in range(0, srcYSize,isize):
            ...
            for j in range(0,srcXSize,isize):
                ...
                for band in range(nbands):
                    ...
                    dataraster = srcband.ReadAsArray(j, i, isize, isize,isize, isize).astype(np.uint8) # 像素值转到[0~255]
