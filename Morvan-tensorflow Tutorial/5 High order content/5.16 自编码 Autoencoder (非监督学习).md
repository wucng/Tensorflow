...
# encoder
en0 = tf.layers.dense(tf_x, 128, tf.nn.tanh) # [batch,128]
en1 = tf.layers.dense(en0, 64, tf.nn.tanh) # [batch,64]
en2 = tf.layers.dense(en1, 12, tf.nn.tanh) # [batch,12]
encoded = tf.layers.dense(en2, 3) # [batch,3]

# decoder
de0 = tf.layers.dense(encoded, 12, tf.nn.tanh) # [batch,12]
de1 = tf.layers.dense(de0, 64, tf.nn.tanh) # [batch,64]
de2 = tf.layers.dense(de1, 128, tf.nn.tanh) # [batch,128]
decoded = tf.layers.dense(de2, 28*28, tf.nn.sigmoid)  # tf.nn.sigmoid 将数值转成（0,1） [batch,28*28]
